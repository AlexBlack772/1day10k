...
describe('ERC721', () => {
   ...
   describe('When detecting the interfaces implemented', () => {
      it('implements ERC165', async () => {
         //supportsInterfaceは、ERC165の標準関数
   ...
   describe('when NFTs are minted', () => {
      ...
      describe('transferFrom()', () => {
         ...
         describe('所有されていない tokenId を転送しようとしたとき', () => {
            it('reverts ', async () => {
               await assertRevert(
         ...
         describe('無効な所有者からトークンを転送しようとしたとき', () => {
            it('reverts ', async () => {
               await assertRevert(
         ...
         describe('トークンをゼロアドレスに転送しようとしたとき', () => {
            it('reverts ', async () => {
               await assertRevert(
