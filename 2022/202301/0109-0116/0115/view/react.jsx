...
//useEffectとは、Reactの機能で、副作用を扱うためのもの
useEffect(didUpdate);
...
//useContextとは、Reactの機能で、コンテキストを扱うためのもの
...
//useCallbackとは、Reactの機能で、メモ化したコールバックを返すためのもの
const memoizedCallback = useCallback(() => {
  doSomething(a, b);
}, [a, b]);

//useMemoとは、Reactの機能で、メモ化した値を返すためのもの
...
//useDeferredValueとは、Reactの機能で、非同期に更新される値を取得するためのもの
const deferredValue = useDeferredValue(value);

//useTransitionとは、Reactの機能で、非同期に更新される値を取得するためのもの
