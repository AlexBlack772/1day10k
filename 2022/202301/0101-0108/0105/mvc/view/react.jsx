...
//useImperativeHandleとは、Reactの機能で、カスタムフックのインスタンスを公開するためのもの
...
//useSyncExternalStoreとは、Reactの機能で、外部ストアを同期的に読み込むためのもの
const state = useSyncExternalStore(subscribe, getSnapshot[, getServerSnapshot]);

//useInsertionEffectとは、Reactの機能で、レイアウトの変更を非同期的に行うためのもの
useInsertionEffect(didUpdate);

//useOpaqueIdentifierとは、Reactの機能で、一意なIDを生成するためのもの
