...
//useRecoilStateとは、Recoilの状態を読み書きするためのカスタムフックです。
...
//selector<T>とは、Recoilの状態を読み書きするためのカスタムフックです。
function selector<T>({
  key: string,
...
//selectorFamily({})とは、selectorのファミリーを作成するための関数です。
...
//useRecoilValueLoadableとは、Recoilの状態を読み書きするためのカスタムフックです。
...
// selectorFamilyとは、パラメータを受け取るselectorのこと
