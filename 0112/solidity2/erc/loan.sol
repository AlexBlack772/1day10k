...
contract UniswapV3Flash {
    ...
    function getPool(
        ...
        //computeAddressとは、poolKeyを元にpoolのアドレスを計算する関数
    ...
    function uniswapV3FlashCallback(
        ...
        //FlashCallbackDataとは、FlashCallbackDataという構造体を定義している
        //memoryとは、メモリ上に変数を定義することを意味する
        //abi.decodeとは、dataをFlashCallbackDataにデコードすることを意味する
...
library PoolAddress {
    ...
    function computeAddress(
        ...
        pool = address(
            uint160(
                uint(
                    //keccak256()を使う理由は、poolのアドレスを計算するため
                    keccak256(
                        abi.encodePacked(
                            hex"ff",
                            factory,
