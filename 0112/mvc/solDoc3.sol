...
//Proxyとは、クライアントコントラクトのオーナーを変更するためのコントラクト
contract Proxy {
...
//TokenCreatorコントラクトは、OwnedTokenコントラクトを作成するためのファクトリです。
...
//function datadata(uint arg1, bool arg2, uint arg3)
    public
...
contract ClientReceipt {
   //eventとは、ブロックチェーン上で発生したトランザクションの情報を記録するためのものです。
    event Deposit(
...
//interfaceとは、コントラクトのインターフェースを定義するために使用されます。
interface Token {
