...
contract CSAMM {
    ...
    //addLiquidityとは、ユーザーが、トークンを追加する関数
    ...
    //removeLiquidityは、ユーザーが、自分の保有しているトークンを、元に戻す関数
...
interface IERC20 {
    ...
    //allowanceとは、あるアドレスが、あるアドレスに対して、いくらのトークンを送ることができるかを示すもの
